...
function assertEthersContractHasMethods(contract) {
  ...
  tsEssentials.assert(ethersContractHasMethods.apply(void 0, [contract].concat(methods)), "Contract must have methods: " + methods.join(', '));
}
...
function buildOrderData(_ref) {
  ...
  var taker = contractTaker || (takerInNonce === ZERO_ADDRESS ? ZERO_ADDRESS : AugustusAddress);
  var order = {
    nonceAndMeta: nonceAndMeta,
    expiry: expiry,
    makerAsset: makerAsset,
...
var constructGetLimitOrders = function constructGetLimitOrders(_ref) {
  ...
  var getRequiredBalance = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(userParams, signal) {
  ...
  var getLimitOrderByHash = /*#__PURE__*/function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(orderHash, signal) {
...
var constructFetcher$2 = function constructFetcher(axios, extra) {
  return /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(params) {
      var headers, _yield$axios$request, data;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 4;
              return axios.request(_extends({}, params, {
                headers: headers
              }));
...
var constructFetcher$1 = function constructFetcher(fetch, extra) {
  return /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(params) {
      var url, method, signal, body, POSTheaders, apiHeaders, headers, response, data;
      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              apiHeaders = extra != null && extra.apiKey ? _extends({
                'X-API-KEY': extra.apiKey
              }, params.headers) : undefined; // all headers combined

              headers = POSTheaders || apiHeaders || params.headers ? _extends({}, apiHeaders, POSTheaders, params.headers) : undefined;
              _context.next = 8;
              return fetch(url, {
                method: method,
                body: body,
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              tsEssentials.assert(isProviderWithSendMethod(provider), 'web3.currentProvider needs to be capable of sending arbitrary rpc calls');
              data = typedData.data, domain = typedData.domain, types = typedData.types;
              _typedData = {
                types: _extends({
                  EIP712Domain: [{
...
exports.constructEthersContractCaller = constructContractCaller$1;
...
exports.constructWeb3ContractCaller = constructContractCaller;
